...
%  sibling label sec:fanout-direction, same undrafted section).
%
...
\subsection{The price is negative probability}
...
\subsection{The Born rule from fibre privacy}
...
\subsection{Local tomography, derived}
...
\autocite{Hardy2001a,muller_p_2011} into a theorem-shaped consequence of the one principle ---
