...
\autocite{woottersOptimalStatedeterminationMutually1989,durtMutuallyUnbiasedBases2010}, and the Koide ratio then follows exactly
as in Proposition~\ref{prop:koide}. The phase is the Bargmann invariant of the triple
\autocite{bargmannNoteWignersTheorem1964}, the argument of the cyclic product of the three overlaps, which
is the one continuous invariant three states possess beyond their overlaps and is the geometric
phase of the geodesic triangle through them
\autocite{pancharatnamGeneralizedTheoryInterference1956,mukundaQuantumKinematicApproach1993}; its octonionic form is the
