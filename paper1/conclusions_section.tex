...
to appear as if it is a non-self-referential ontological causal sequence as suggested in \autocite{small2005}.
...
As stated in the introduction are many open problems to be resolved and I've exported the entire
train of colaboration with Claude into \autocite{zenodo_reference} to make it easy for anyone to 
pick up the context, pick out the problems and start solving them.
...
to paper2. A very rough outline is present in the Claude brain dump referenced above.
