...
separately: the principle of reversible continuity (\S\ref{sec:continuity}) --- that a continuous
reversible transformation connects any two pure states --- selects the $L^{2}$ norm uniquely.
...
of the $L^{2}$ conclusion is carried jointly with the independent isometry and counting arguments.
