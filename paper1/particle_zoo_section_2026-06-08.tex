...
% EDITED 2026-09-12 scripts/patch_restore_zoo_signpost_prose_2026-09-12T2300.py
...
$(1,2,3)$, $(1,4,5)$ and $(1,7,6)$ of the multiplication table fixed in Appendix~\ref{app:setup}
--- each a quaternionic subalgebra. Those three lines are the three colour lines of
$\mathbb{C}^3$, not three generations (\S\ref{sec:sedenions-promotion}): triality is not induced
by any automorphism of the octonions, and the generation three comes one rung up, from the $S_3$
that the doubling to the sedenions adds to the automorphism group, acting on the three octonion
halvings (\S\ref{sec:sedenions-generations}), of which the count here is read as the shadow
(\S\ref{sec:sedenions-shadow}). The same count of three is reached independently from the
complex sedenions and from chains of division-algebra ideals
