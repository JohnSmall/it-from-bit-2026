% EDITED 2026-09-16 scripts/patch_thomson_lamp_typos_2026-09-16T1600.py
...
suppose it starts out switched on, after the first minute we toggle it off, then half a minute
later we toggle it on, then 15 seconds later we toggle it off, and so on. After 2 minutes we
