...
number of actions. The final state cannot to represented as either on or off but has a perfectly
valid representation as being in a superposition of being on and off at the same time. Also
super-task can exceed the bounds of a Turing machine (refs). Once wen know the basic forms of
self-rerference it's easy to see how they're smuggled in to different interpretations of quantum
mechanids
...
epistemological view of the matter and developing a propensity view of probability (refs). I
...
\enquote{}quote{Wigner's friend} \autocite{wigner_1961} implemented in a series of classical
...
\autocite{aaronson_lect9,Aaronson:dem} are particularly useful.
...
Aaronson \autocite{aaronson_lect9, Aaronson:dem} takes a different approach. Accept negative
