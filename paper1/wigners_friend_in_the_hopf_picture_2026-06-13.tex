...
(\S\ref{sec:sedenion-announcement}). No fibration comes with it --- the
...
(\S\ref{sec:sedenion-announcement}). The fourth observer, then, sees no new
...
label (\S\ref{sec:wf-chain-type}, \S\ref{sec:sedenion-announcement}). The
