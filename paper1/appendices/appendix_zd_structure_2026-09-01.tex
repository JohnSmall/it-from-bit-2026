% EDITED 2026-09-12 scripts/patch_gunaydin_citekey_2026-09-12T2100.py
...
\autocite{gunaydingursey1974quark}. Then the unit zero divisors with direction $j$ are exactly the
