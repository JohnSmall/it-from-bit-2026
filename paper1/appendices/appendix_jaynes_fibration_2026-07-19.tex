%  KEY RECONCILIATION 2026-08-23: citation keys audited against
%  self-ref-2026.bib. Six keys remapped to existing library entries:
%    jaynes1990probability       -> Jaynes_89_a
%    wigner1961remarks           -> wigner_1961
%    landauer1961irreversibility -> Landauer_1961
%    wootters1981statistical     -> wooters_1981   [sic: library spelling]
%    coecke2017picturing         -> CoeckeKissinger2017
%    pusey2012reality            -> Pusey2012b
%  Thirteen keys are new to the library; RIS for Mendeley import in
%  jaynes_references_2026-08-23.ris (supersedes the 07-19 RIS, which
%  should be atticked once the new import is confirmed). DEDUPE-CHECK
%  on import: abramsky2011sheaf (library holds Abramsky-Brandenburger
%  2014, a different paper; a 2011 sheaf entry could exist in an
%  unsighted region of the bib), zurek2003decoherence (library is
%  Zurek-dense; the RMP review specifically was not found),
%  schrodinger1936probability, bargmann1954unitary (classics; not
%  found, but absence not proved). The sibling insert
%  jaynes_paragraph_2026-07-19.tex needs the single swap
%  jaynes1990probability -> Jaynes_89_a; its other keys arrive via the
%  RIS.
% =====================================================================
...
%  citation keys exist.
%
%  CITATION KEYS. Six keys in this file are existing library entries:
%    Jaynes_89_a, wigner_1961, Landauer_1961, wooters_1981,
%    CoeckeKissinger2017, Pusey2012b.
%  Thirteen keys are NEW (RIS entries for Mendeley import in
%  jaynes_references_2026-08-23.ris):
%    schrodinger1936probability, hughston1993ensemble,
%    steenrod1951topology, berry1984quantal, simon1983holonomy,
%    bengtsson2006geometry, atiyah1982convexity, selinger2007dagger,
%    abramsky2011sheaf, zurek2003decoherence, cleve1998quantum,
%    bargmann1954unitary, harrigan2010einstein.
%  Check the DEDUPE-CHECK flags above before importing, and reconcile
...
Jaynes's complaint \autocite{Jaynes_89_a} is that the
...
\S\ref{sec:l2-metric-fibre}, of which the qubit case $S^{3} \to S^{2}$ is the
...
\S\ref{sec:born-invariance}, is that the fibre coordinate is the observer's
...
\S\ref{sec:born-invariance}; its off-diagonal entries are the relative phases,
...
identified in \S\ref{sec:born-invariance} --- the minimum-degree passage from
...
Kissinger \autocite{CoeckeKissinger2017} --- which annihilates global
...
(\S\ref{sec:fanout-boundary}) sits downstream of this doubling; the present
...
\autocite{wooters_1981}; the imaginary part is the
...
correspondence of \S\ref{sec:fanout-boundary} supplies the formal home for that
...
\autocite{Landauer_1961}; its thermodynamic ledger is
...
\autocite{wigner_1961}: the friend's overall phase is
...
wooters_1981, bengtsson2006geometry}; the ensemble
...
CoeckeKissinger2017}. None of this is ours, and none of it is at
stake.
...
(\S\ref{sec:self-reference}, \S\ref{sec:born-invariance}); that the nonvanishing
...
Barrett and Rudolph \autocite{Pusey2012b}, which --- within the
...
% jaynes_references_2026-08-23.ris; VERIFY page ranges at final
% drafting). Six further keys used above are existing library
% entries --- Jaynes_89_a, wigner_1961, Landauer_1961, wooters_1981,
% CoeckeKissinger2017, Pusey2012b --- and have no stubs here.
