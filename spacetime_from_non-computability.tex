...
%     sec:entanglement-classes, sec:k3-sterile  -- the SM gauge-group / K3 sections
% British English throughout.
% =====================================================================
...
framework's Class-4 a-chiral sterile neutrino (Section~\ref{sec:entanglement-classes}) is
