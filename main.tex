...
\subsection{Where does $C^+$ fit into this? Hopf fibrations and entanglement}
Let's return to Poppers $C+$, $C$ and $E$, or in modern terms, Wigner, his friend and thing being measured. It's useful to analyse this in the framework of Hopf fibrations. We have a 2 state quantum system, which along with complex probability amplitudes gives us 4 directions with the restric
